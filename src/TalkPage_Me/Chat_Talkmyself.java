...
public class Chat_Talkmyself {
    ...
    private static JLabel Make_Background_and_Chat(String chat_str) {
        ...
        ImageIcon LEFT_UPI = new ImageIcon("image/TalkPage/chat/left/leftup.png");
        ...
        ImageIcon LEFT_DOWNI = new ImageIcon("image/TalkPage/chat/left/leftdown.png");
        ...
        ImageIcon RIGHT_DOWNI = new ImageIcon("image/TalkPage/chat/right/rightdown.png");
        ...
        ImageIcon RIGHT_UPI = new ImageIcon("image/TalkPage/chat/right/rightup1.png");
        ...
        ImageIcon RIGHTI = new ImageIcon("image/TalkPage/chat/right/right1.png");
        ...
        UP.setOpaque(false);
        ImageIcon UPI = new ImageIcon("image/TalkPage/chat/up_down/up.png");
