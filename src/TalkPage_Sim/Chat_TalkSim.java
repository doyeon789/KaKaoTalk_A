...
import static TalkPage_Sim.TalkPage_Sim.Mode;
import static TalkPage_Sim.TalkPage_Sim.MessageFromSim;
        ...
        switch (Mode){
            ...
            case 2:
                ...
                if(!isTextFirst_Sim){
                    ...
                    if(messageMinutes_Sim.getLast().equals(messageMinutes_Sim.get(messageMinutes_Sim.size()-2))){
                        if(messageTimes_Sim.getLast().isAfter(messageTimes_Sim.get(messageTimes_Sim.size()-2))){
